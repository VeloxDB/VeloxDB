...
https://vlxdb.com/vlxdoc/articles/guide/getting_started.html - the perfect 
...
http://vlxdb.com/vlxdoc/articles/guide/introduction.html - a comprehensive 
...
The VeloxDB API Reference - http://vlxdb.com/vlxdoc/api - a complete reference 
...
in the data folder and logs in the log folder. You can find more information 
about the default configuration in the vlxdbcfg.json and config.cluster.json 
files.
To upload your code into the database, use the vlx client app.
