...
using static Velox.Client.ConnectionPool;
...
public static class ConnectionFactory
{
	...
	/// <summary>
	/// Creates VeloxDB connection using supplied connection string. Use <see cref="Velox.Client.ConnectionStringParams"/> to create connection string.
	/// </summary>
