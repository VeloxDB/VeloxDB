...
public enum DatabaseErrorType
{
	...
	/// See <see cref="T:Velox.ObjectInterface.DatabaseReferenceAttribute"/>.
	/// </summary>
	...
	/// indexes see <see href="~/articles/indexing.md">Indexes</see>.
	/// </summary>
	...
	/// <summary>
	/// Inverse reference property is of invalid type. Inverse references must be of type <see cref="T:Velox.ObjectInterface.InverseReferenceSet`1"/>.
	/// </summary>
	...
	/// <summary>
	/// Class is not decorated with <see cref="T:Velox.ObjectInterface.DatabaseClassAttribute"/>.
	/// </summary>
	...
	/// <see cref="T:Velox.ObjectInterface.DatabasePropertyAttribute"/>.
	/// </summary>
	[ErrorCode("Property {4} of class {5} has an invalid type.")]
